...
from clientforge import AsyncForgeClient, ClientCredentialsOAuth2Auth, ForgeClient
...
class AsyncKrogerClient(AsyncForgeClient):
    """Kroger API client (async).
    ...
    async def get_location(self, location_id: str) -> Result[Location]:
        """Get a location by its ID.
